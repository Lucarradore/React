...
const SectionTitle = ({ title }) => (
  <>
    <motion.h2
      className="text-4xl tracking-tighter lg:text-5xl"
    ...
    <motion.div
      className="mb-4 mt-2 h-2 w-32 bg-rose-300 lg:-rotate-3"
      initial={{ opacity: 0, y: 50 }}
      animate={{ opacity: 1, y: 0 }}
...
const SobreNosotrosContent = () => {
  return (
    <section className="container mx-auto py-16 px-4" id="sobre-nosotros">
      ...
      <div className="flex flex-col lg:flex-row items-start lg:items-center mt-20">
        ...
        <div className="w-full lg:w-1/3 p-4">
          ...
          <motion.img
            src={aboutImageUno}
            alt="Sobre Nosotros"
            className="rounded-3xl lg:-rotate-3 mt-16"
            initial={{ opacity: 0, x: -50 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.6, delay: 0.2 }}
          />
