...
const Dishes = () => {
  ...
  return (
    <section className="container mx-auto py-16" id="dishes">
      ...
      <aside className="fixed bottom-4 right-4 bg-gray-800 text-white p-4 rounded-lg shadow-lg w-64">
        ...
        {cart.length > 0 && (
          <>
            <button
              className="mt-4 w-full bg-green-900 py-2 rounded-lg"
              onClick={confirmPurchase}
            >
              Confirmar Compra
            </button>
            <button
              className="mt-2 w-full bg-red-800 py-2 rounded-lg"
              onClick={clearCart}
            >
              Vaciar Carrito
            </button>
